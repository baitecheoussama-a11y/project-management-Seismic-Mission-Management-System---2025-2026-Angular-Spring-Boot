...
import { Component, Output, EventEmitter, OnInit, OnDestroy, ChangeDetectorRef, forwardRef,Input } from '@angular/core';
...
@Component({
  ...
  <div *ngIf="canViewAllProjects">
    ...
    <div class="filter-controls">
      ...
      <select 
        ...
        <option *ngFor="let mission of missions" [value]="mission.id?.toString()">
  ...
  <!-- للـ Regular Users - عرض رسالة مبسطة فقط -->
      ...
      <div class="advanced-filters" *ngIf="showAdvancedFilters">
        ...
        <div class="filter-row">
          <div class="filter-field">
            ...
            <input type="text" [ngModel]="filterValues.nom" (ngModelChange)="updateFilter('nom', $event)" placeholder="Search by name..." class="filter-input">
          </div>
          <div class="filter-field">
            <label><i class="fas fa-align-left"></i> Description</label>
            <input type="text" [ngModel]="filterValues.description" (ngModelChange)="updateFilter('description', $event)" placeholder="Search in description..." class="filter-input">
          </div>
        </div>
        ...
        <div class="filter-row">
          <div class="filter-field">
            ...
            <div class="range-inputs">
              <input type="number" [ngModel]="filterValues.budgetMin" (ngModelChange)="updateFilter('budgetMin', $event)" placeholder="Min" class="filter-input small">
              <span>-</span>
              <input type="number" [ngModel]="filterValues.budgetMax" (ngModelChange)="updateFilter('budgetMax', $event)" placeholder="Max" class="filter-input small">
            </div>
          </div>
          <div class="filter-field">
            <label><i class="fas fa-flag-checkered"></i> Target VP Range</label>
            <div class="range-inputs">
              <input type="number" [ngModel]="filterValues.vpMin" (ngModelChange)="updateFilter('vpMin', $event)" placeholder="Min" class="filter-input small">
              <span>-</span>
              <input type="number" [ngModel]="filterValues.vpMax" (ngModelChange)="updateFilter('vpMax', $event)" placeholder="Max" class="filter-input small">
            </div>
          </div>
        </div>
        ...
        <div class="filter-row">
          <div class="filter-field">
            ...
            <div class="date-range">
              <input type="date" [ngModel]="filterValues.startDateFrom" (ngModelChange)="updateFilter('startDateFrom', $event)" class="filter-input">
              <span>to</span>
              <input type="date" [ngModel]="filterValues.startDateTo" (ngModelChange)="updateFilter('startDateTo', $event)" class="filter-input">
            </div>
          </div>
          <div class="filter-field">
            <label><i class="fas fa-calendar-check"></i> End Date</label>
            <div class="date-range">
              <input type="date" [ngModel]="filterValues.endDateFrom" (ngModelChange)="updateFilter('endDateFrom', $event)" class="filter-input">
              <span>to</span>
              <input type="date" [ngModel]="filterValues.endDateTo" (ngModelChange)="updateFilter('endDateTo', $event)" class="filter-input">
            </div>
          </div>
        </div>
        ...
        <div class="filter-row">
          <div class="filter-field">
            ...
            <div class="date-range">
              <input type="date" [ngModel]="filterValues.actualEndDateFrom" (ngModelChange)="updateFilter('actualEndDateFrom', $event)" class="filter-input">
              <span>to</span>
              <input type="date" [ngModel]="filterValues.actualEndDateTo" (ngModelChange)="updateFilter('actualEndDateTo', $event)" class="filter-input">
            </div>
          </div>
...
export class MissionFilterComponent implements OnInit, OnDestroy {
  ...
  showAdvancedFilters: boolean = false;
    @Input() canViewAllProjects: boolean = false; // ✅ أضف هذا
  ...
  // Method to reset to all missions
  resetToAllMissions() {
    this.selectedMissionId = 'all';
    this.onMissionChange();
  }

  // Method to set specific mission
  setMission(missionId: number) {
    this.selectedMissionId = missionId.toString();
    this.onMissionChange();
  }
}