...
public class TypeEvenementResponseDTO {
    ...
    // Constructors
    public TypeEvenementResponseDTO() {}

    public TypeEvenementResponseDTO(Long id, String nom, String description, String niveauPriorite,
    ...
    public Integer getEvenementsCount() {
        return evenementsCount;
    }

    public void setEvenementsCount(Integer evenementsCount) {
        this.evenementsCount = evenementsCount;
    }
}